...
const Navbar = () => {
  ...
  const navLinks = [
    ...
    ...(user ? [{ to: "/my-booking", label: t("nav.myBookings") }] : []),
  ];
          ...
          <div className="flex justify-between items-center h-16 sm:h-20">
            ...
            <div className="hidden md:flex items-center space-x-4">
              ...
              <div className="relative group">
                ...
                {/* Language Dropdown */}
                <div className="absolute right-0 top-full mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-100 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                  <div className="py-2">
                    {languages.map((lang) => (
                      <button
                        key={lang.code}
