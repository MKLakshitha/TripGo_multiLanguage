...
const Experience = () => {
  ...
  return (
    ...
    >
      ...
      >
        {t("experience.title")} <span className="text-blue-500">{t("experience.tripgo")}</span>
      </motion.h1>
      <motion.p
      ...
      >
        {t("experience.subtitle")} <br />
        {t("experience.subtitleLine2")}
      </motion.p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-12 max-w-6xl mx-auto">
        ...
        >
          ...
          <h6 className="text-lg text-gray-600">{t("experience.successfulTrips")}</h6>
        </motion.div>
        ...
        >
          ...
          <h6 className="text-lg text-gray-600">{t("experience.regularClients")}</h6>
        </motion.div>
        ...
        >
          ...
          <h6 className="text-lg text-gray-600">{t("experience.experience")}</h6>
        </motion.div>
      </div>
    </motion.div>
  );
