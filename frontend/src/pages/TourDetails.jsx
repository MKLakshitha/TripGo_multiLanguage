...
const TourDetails = () => {
  ...
  if (!tour) return <div className="text-center py-12">{t("tourDetails.tourNotFound")}</div>;
      ...
      <div className="max-w-6xl mx-auto space-y-10">
        ...
        <div className="relative h-96 md:h-[500px] overflow-hidden rounded-3xl shadow-lg">
          ...
          <div className="absolute bottom-8 left-8 text-white">
            ...
            <div className="flex items-center space-x-4 text-sm md:text-lg">
              ...
              <div className="flex items-center space-x-1">
                <Calendar size={18} />
                <span>{availableDates.length} {t("tourDetails.dates")}</span>
              </div>
              <div className="flex items-center space-x-1">
                <Users size={18} />
                <span>{t("tourDetails.max")} {maxGroupSize}</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            <div className="text-xl text-gray-800 leading-relaxed">{t(desc)}</div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="bg-white/80 p-5 rounded-xl shadow border">
                <div className="flex items-center space-x-2 text-gray-700 mb-2">
                  <DollarSign size={20} />
                  <span className="font-semibold">{t("tourDetails.price")}</span>
                </div>
              ...
              <div className="bg-white/80 p-5 rounded-xl shadow border">
                <div className="flex items-center space-x-2 text-gray-700 mb-2">
                  <MapPin size={20} />
                  <span className="font-semibold">{t("tourDetails.distance")}</span>
                </div>
                <p className="text-xl">{distance} {t("tourDetails.kmAway")}</p>
              </div>
            </div>
          ...
          <div className="bg-white/90 rounded-xl p-6 shadow space-y-6 border">
            <div>
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-gray-600">{avgRating} {t("tourDetails.stars")}</span>
              </div>
              <p className="text-gray-600 mt-1">{reviews.length} {t("tourDetails.reviews")}</p>
            </div>
