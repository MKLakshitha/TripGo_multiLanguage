                      ...
                      <div className="flex-1">
                        <div className="flex items-start justify-between mb-3">
                          <div>
                            ...
                            <div className="flex items-center space-x-1 text-gray-500 text-sm">
                              <span>{t("myBookings.bookingId")}:</span>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 text-sm">
                          <div className="flex items-center space-x-2">
                            ...
                            <div>
                              <div className="text-gray-500">{t("myBookings.travelerName")}</div>
                          ...
                          <div className="flex items-center space-x-2">
                            ...
                            <div>
                              <div className="text-gray-500">{t("myBookings.totalAmount")}</div>
                          ...
                          <div className="flex items-center space-x-2">
                            ...
                            <div>
                              <div className="text-gray-500">{t("myBookings.bookingDate")}</div>
                              <div className="font-semibold text-gray-800">
