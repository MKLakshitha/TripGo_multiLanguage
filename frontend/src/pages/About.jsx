  ...
  return (
    <div className="about-page">
      ...
      >
        ...
        >
          {t("about.title")} <span className="text-blue-400">{t("about.tripgo")}</span>
        </motion.h1>
        <motion.p
      ...
      <section className="about-intro py-16 px-4 bg-light-gray">
        ...
        >
          ...
          >
            {t("about.aboutTitle")} <span className="text-blue-500">{t("about.tripgo")}</span>
          </motion.h2>
          <motion.p
            className="text-lg"
            initial={{ opacity: 0, y: -20 }}
      ...
      <section className="our-mission py-16">
        ...
        >
          <motion.h2
            ...
            transition={{ delay: 0.3, duration: 0.6 }}
          >
            {t("about.missionTitle")} <span className="text-blue-500">{t("about.mission")}</span>
          </motion.h2>
          <motion.p
            className="text-lg"
            initial={{ opacity: 0, y: -20 }}
      ...
      <section className="why-choose-us py-16 bg-light-gray">
        ...
        >
          <motion.h2
            ...
            transition={{ delay: 0.3, duration: 0.6 }}
          >
            {t("about.whyChooseTitle")} <span className="text-blue-500">{t("about.us")}</span>
          </motion.h2>
            ...
            {[
              {
                ...
                title: t("about.professionalService"),
                desc: t("about.professionalDesc"),
              },
              {
                ...
                title: t("about.uniqueDestinations"),
                desc: t("about.uniqueDesc"),
              },
              {
      ...
      <section className="our-team py-16 bg-white/20">
        ...
        >
          <motion.h2
            ...
            transition={{ delay: 0.3, duration: 0.6 }}
          >
            {t("about.teamTitle")} <span className="text-blue-500">{t("about.team")}</span>
          </motion.h2>
            ...
            {[
              {
                ...
                name: "Jane Doe",
                title: t("about.travelConsultant"),
              },
              {
                ...
                name: "John Smith",
                title: t("about.travelSpecialist"),
              },
            ].map((item, index) => (
              <motion.div
                key={index}
      ...
      <section className="contact-info py-16 bg-light-gray text-center">
        ...
        >
          <motion.h2
            ...
            transition={{ delay: 0.3, duration: 0.6 }}
          >
            {t("about.contactTitle")} <span className="text-blue-500">{t("about.touch")}</span>
          </motion.h2>
